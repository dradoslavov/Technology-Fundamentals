...
namespace _07.Objects_and_Classes___Exercise
{
    class Program
    {
        static void Main(string[] args)
        {
            int countMesages = int.Parse(Console.ReadLine());
            ...
            for (int i = 0; i < countMesages; i++)
            {
                ...
                Console.WriteLine($"{phrase} {@event} {author} {citi}");
